...
if [ $# -ne 1 ]
  then
    echo "A single argument corresponding to a new run directory name is required."
    exit 1
fi
...
python3 DEbass_extractSpec.py --redArm PATH_TO_Red*.p11.fits --blueArm PATH_TO_Blue*.p11.fits --skySub 
...
python3 DEbass_spliceSpec.py --blueArm OBK-282624-WiFeS-Red--UT20230312T111056-9.p12_SN.fits --redArm OBK-282624-WiFeS-Blue-UT20230312T111056-9.p12_SN.fits --scale
